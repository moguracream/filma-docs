---
title: AI時代の会員制動画配信ページ構築基盤 Filma
---

# AI時代の会員制動画配信ページ構築基盤 Filma
...
[問い合わせフォーム（準備中）](/developers/contact-form/) / [APIとサンプルを見る](#開発者向け情報)

## このページで分かること

- [Filmaが向いている企業](#こんな方に向いています)
- [動画配信ページ構築で起きやすい課題](#動画配信ページは見た目よりも開発範囲が広がりやすい)
- [Web制作・開発会社、講座配信、IP配信での活用例](#web制作システム開発会社向け)
- [外部システムやAPIとの連携イメージ](#外部システムとapiでつなげられます)
- [構成相談の前に整理したいこと](#まずは構成を相談してください)
...
- [Filma技術概要](/developers/technical-overview/)
- [APIリファレンス](/api-spec/)
...
[問い合わせフォーム（準備中）](/developers/contact-form/)

Googleフォームを準備中です。GitHub Pages上で埋め込み表示ができない場合は、通常のフォームリンクとして掲載します。
...
- [ご利用規約](/terms_of_service_template)
- [サービスレベルアグリーメント](/service_level_agreement)
